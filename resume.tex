...
\section{EXPERIENCE}
\employer{Hewlett Packard, Inc.}
\location{Phoenix, AZ}
\dates{October 2019 to Current}
\title{\textbf{IT Technician}}
\begin{position}
	Installed and configured networking protocols on HP point of sales registers; performed survey analysis on bank MDF racks (router, switch, Meraki, server, MPOE, etc.).
\end{position}

\employer{Dick's Sporting Goods}
\location{Tempe, AZ}
\dates{June 2019 to October 2019}
